...
type HSLContextType ={HSLtoggle:boolean,setHSLtoggle:(t:boolean)=>void}

export const HSLContext=createContext<HSLContextType>({} as HSLContextType)
...
export const HSL=()=>{
    ...
    return(
        ...
        <div className="HSLHSVLabel">
            ...
            <CN_Label4HSL_HSV textcolor={textColor?1:0} toggle={HSLtoggle?1:0} onClick={()=>setHSLtoggle(true)}>HSL</CN_Label4HSL_HSV>

            <CN_Label4HSL_HSV textcolor={textColor?1:0} toggle={!HSLtoggle?1:0} onClick={()=>setHSLtoggle(false)}>HSV</CN_Label4HSL_HSV>
